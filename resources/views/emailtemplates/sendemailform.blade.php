                     ...
                     <div class="col-sm-12">
                        <div class="page-title-box">
                           <div class="row align-items-center">
                              <div class="col-md-8">
                                 <h4 class="page-title mb-0">Send Email </h4>
							...
							<div class="col-12">
								<div class="card">
									<div class="card-body">
										...
										<div class="form-body">
                            <form method="post" action="{{ url('/emailtemplates/sendEmail') }}" enctype="multipart/form-data" autocomplete="off"> 
                                <div class="row">
                                    <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"  required name="subject" id="subject" placeholder="Enter subject"> 
                                            @error('subject')
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="mytextarea" required name="email_text" aria-hidden="true" ></textarea>
                                              @error('email_text')
                                                <span class="error_msg">{{$message}}</span>
                                            @enderror
                                        </div>    
