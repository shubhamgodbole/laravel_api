                     ...
                     <div class="col-sm-12">
                        <div class="page-title-box">
                           <div class="row align-items-center">
                              <div class="col-md-8">
                                 <h4 class="page-title mb-0">Update Ads</h4>
                                 <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="{{ url('/ads') }}">Ads</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Update Ads</li>
                                 </ol>
                              </div>
                              <div class="col-md-4">
							...
							<div class="col-12">
								<div class="card">
									<div class="card-body">
										...
										<div class="form-body">
                            <form method="post" action="{{ url('/ads/updateAds') }}" enctype="multipart/form-data" autocomplete="off"> 
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            @foreach($category as  $index => $u)
                                            <option value={{$u->id}}  {{ $edit_data->category_id == $u->id ? "selected" : "" }}>{{$u->title}}</option>
                                            @endforeach    
                                            </select>
                                            @error('status')
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $edit_data->title }}" class="form-control" required name="title" id="first_name" placeholder="Enter title"> 
                                            @error('title')
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea  class="form-control" required name="description" id="description">{{ $edit_data->description }}</textarea> 
                                            @error('description')
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <img id="output" src={{$edit_data->image}} height="200" width = "200" />
                                        <script>
