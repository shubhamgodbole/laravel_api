                ...
                <div class="card-body">
                    <div class="p-3">
                        <div class="float-right text-right">
                            <h4 class="font-18 mt-3 m-b-5">Verify OTP !!</h4>
                        </div>
                        <a href="#" class="logo-admin"><img src=" {{ asset('public/images/logo_dark.png') }} " height="26" alt="logo"></a>
                    </div>
                    <div class="p-3">
                        <form class="form-horizontal m-t-10" method="post" action="verifyOTP" autocomplete="off">
                            <div class="form-group">
                                <label for="username">OTP</label> 
                                <input type="text" class="form-control" name="otp" placeholder="Enter otp">
                                <input type="hidden" class="form-control" name="request_type" value="forgotpassword" placeholder="Enter otp">
                            ...
                            <div class="form-group m-t-30 mb-0 row">
                                <div class="col-12 text-center">
                                    <a href="{{ url('/resendOTP') }}" class="text-muted"><i class="fa fa-lock "></i> Resned?</a>
                                </div>
                                {{ csrf_field() }}
                            </div>
                        </form>
