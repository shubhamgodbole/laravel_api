                     ...
                     <div class="col-sm-12">
                        <div class="page-title-box">
                           <div class="row align-items-center">
                              <div class="col-md-8">
                                 <h4 class="page-title mb-0">Edit Coupon</h4>
                  ...
                  <!-- end row -->
					<div class="row">
							<div class="col-12">
								<div class="card">
									<div class="card-body">
										<h4 class="mt-0 header-title">Edit Coupan</h4>
										<div class="form-body">
                                            <form method="post" action="{{ url('/coupans/updateCoupan') }}" enctype="multipart/form-data" autocomplete="off"> 
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="coupan_code">Coupon Code</label> 
                                                            <input type="hidden"  value="{{ $edit_data->id }}" name="id">
                                                            <input type="text" value="{{$edit_data->coupan_code}}" class="form-control" required name="coupan_code" id="coupan_code" placeholder="Enter coupan code"> 
                                                            @error('coupan_code')
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group bootstrap-touchspin bootstrap-touchspin-injected">
                                                                ...
                                                                <input id="discount_percentage" value="{{$edit_data->discount_percentage}}"  type="text" value="0" name="discount_percentage" class="form-control">
                                                            </div>
                                                        </div>    
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"  value="{{$edit_data->minimum_transaction_amount}}" required name="minimum_transaction_amount" id="minimum_transaction_amount" placeholder="Enter minimum cart amount"> 
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" required name="maximum_discount_amount" value="{{$edit_data->maximum_discount_amount}}" id="maximum_discount_amount" placeholder="Enter minimum cart amount"> 
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="date" class="form-control datepicker" value="{{$edit_data->start_date}}" required name="start_date" id="start_date" > 
                                                            @error('start_date')
                                                                <span style="color:red" class="help-block">{{$message}}</span>
                                                            @enderror
                                                        </div>    
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="date" class="form-control datepicker" value="{{$edit_data->end_date}}"  name="end_date" id="end_date" > 
                                                            @error('end_date')
                                                                <span style="color:red" class="help-block">{{$message}}</span>
                                                            @enderror
                                                        </div>    
