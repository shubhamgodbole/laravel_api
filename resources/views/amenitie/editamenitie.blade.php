                     ...
                     <div class="col-sm-12">
                        <div class="page-title-box">
                           <div class="row align-items-center">
                              <div class="col-md-8">
                                 <h4 class="page-title mb-0">Update Amienitie</h4>
                                 <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="{{ url('/amenities') }}">Amenitie</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Update Amienitie</li>
                                 </ol>
                              </div>
                              <div class="col-md-4">
							...
							<div class="col-12">
								<div class="card">
									<div class="card-body">
										...
										<div class="form-body">
                            <form method="post" action="{{ url('/amenities/updateAmenitie') }}" enctype="multipart/form-data" autocomplete="off"> 
                                <div class="row">
                                    <div class="col-md-6">
