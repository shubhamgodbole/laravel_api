               ...
               <div class="container-fluid">
                     ...
                     <div class="col-sm-12">
                        <div class="page-title-box">
                           <div class="row align-items-center">
                              <div class="col-md-8">
                                 <h4 class="page-title mb-0">Amenities</h4>
                              </div>
	                            <div class="col-md-4">
									<div class="float-right ">
										<div class="">
											<a class="btn btn-primary btn-rounded " href="{{ url('/amenities/add_amenitie') }}" > Add New</a>
										</div>
									</div>
								</div>
                           </div>
                  ...
                  <!-- end row -->
							...
							<div class="col-12">
								<div class="card">
									<div class="card-body">
										<h4 class="mt-0 header-title">Amenities</h4>
										<div class="">
								  ...
								  <th>Actions</th>
											...
											<tbody>
								@foreach($aminite as  $index => $u)
									<tr>
										<th scope="row">{{  $index + 1  }}</th>
										<td>{{ $u->name }}</td>
										<td> <img src="{{ $u->icon }}" class="img-fluid img-thumbnail" alt="" height="30" width="50"></td>
										...
										<td>
													...
													<div class="dropdown-menu dropdown-menu-right dropdown-menu-animated">
														<a class="dropdown-item" href="amenities/edit_amenitie/{{$u->id}}">Edit</a> 
            ...
            swal({
                ...
                .then((willDelete) => {
					if (willDelete) {
						$.ajax({
							type: "GET",
							url : "{{url('amenities/deletAmenitie')}}" + "/" + id,
            ...
            swal({
                ...
                .then((willDelete) => {
					if (willDelete) {
						$.ajax({
							type: "GET",
							url : "{{url('amenities/changeActivationStatus/')}}" + "/" + id,
							success: function (data) {
								if(data) {
									//swal("Deleted Successfully");
									toastr.options = {
