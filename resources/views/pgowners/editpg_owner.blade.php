                     ...
                     <div class="col-sm-12">
                        <div class="page-title-box">
                           <div class="row align-items-center">
                              <div class="col-md-8">
                                 <h4 class="page-title mb-0">Update PG Owners</h4>
                                 <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="#">PG Owners</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Update PG Owners</li>
                                 </ol>
                              </div>
                              <div class="col-md-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="d-flex justify-content-center my-4">
                                            <div class="w-75">
                                                <input type="range" name="profit" class="custom-range" id="customRange11" value="{{ $edit_data->profit }}" min="0" max="100" step="10">
                                            </div>
