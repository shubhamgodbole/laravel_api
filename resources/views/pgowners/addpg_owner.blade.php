                     ...
                     <div class="col-sm-12">
                        <div class="page-title-box">
                           <div class="row align-items-center">
                              <div class="col-md-8">
                                 <h4 class="page-title mb-0">Add PG Owners</h4>
                                 <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="{{ url('pg_owners') }}">PG Owners</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Add PG Owners</li>
                                 </ol>
                              </div>
                              <div class="col-md-4">
							...
							<div class="col-12">
								<div class="card">
									<div class="card-body">
										...
										<div class="form-body">
                            <form method="post" action="addOwner" enctype="multipart/form-data" autocomplete="off"> 
                                <div class="row">
                                    <div class="col-md-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                        <label for="password">Profit Slabe</label>
                                        <div class="d-flex justify-content-center my-4">
                                            <div class="w-75">
                                                <input type="range" name="profit" class="custom-range" id="customRange11" value="10" min="0" max="100" step="10">
                                            </div>
                                            <span class="font-weight-bold text-primary ml-2 valueSpan2"></span><span class="font-weight-bold text-primary">%</span>
                                            </div>
                                        </div>    
                                    </div>
                                </div>
