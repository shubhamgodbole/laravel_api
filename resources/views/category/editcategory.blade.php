                     ...
                     <div class="col-sm-12">
                        <div class="page-title-box">
                           <div class="row align-items-center">
                              <div class="col-md-8">
                                 <h4 class="page-title mb-0">Update Category</h4>
                                 <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="{{ url('/amenities') }}">Categories</a></li>
							...
							<div class="col-12">
								<div class="card">
									<div class="card-body">
										...
										<div class="form-body">
                            <form method="post" action="{{ url('/category/updateCategory') }}" enctype="multipart/form-data" autocomplete="off"> 
                                <div class="row">
                                    <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <img id="output" src={{$edit_data->icon}} height="200" width = "200" />
                                        <script>
