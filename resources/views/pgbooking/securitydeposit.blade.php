               ...
               <div class="container-fluid">
                     ...
                     <div class="col-sm-12">
                        <div class="page-title-box">
                           <div class="row align-items-center">
                              <div class="col-md-8">
                                 <h4 class="page-title mb-0">Security Deposits</h4>
                              </div>
								<div class="col-md-4">
                  ...
                  <!-- end row -->
							...
							<div class="col-12">
								<div class="card">
									<div class="card-body">
										<h4 class="mt-0 header-title">Security Deposits</h4>
                                  ...
                                  <th>Action</th>
											...
											<tbody>
								@foreach($securityDeposts as  $index => $u)
									<tr>
										...
										<td>
													...
													<div class="dropdown-menu dropdown-menu-right dropdown-menu-animated">
														<a class="dropdown-item" href="security_diposits/edit_security_diposits/{{$u->id}}">Update</a> 
													</div>
												</div>
											 	</td>
									</tr>
