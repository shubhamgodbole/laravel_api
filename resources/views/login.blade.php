                ...
                <div class="card-body">
                    <div class="p-3">
                        <div class="float-right text-right">
                            ...
                            <p class="text-muted">Sign in to continue to PayPg.</p>
                        </div>
                        <a href="#" class="logo-admin"><img src=" {{ asset('public/images/logo_dark.png') }} " height="75" alt="logo"></a>
                    </div>
                    <div class="p-3">
                        <form class="form-horizontal m-t-10" method="post" action="check_login" autocomplete="off">
                            ...
                            <div class="form-group m-t-30 mb-0 row">
                                <div class="col-12 text-center">
                                    <a href="{{ url('/forget_password') }}" class="text-muted"><i class="fa fa-lock "></i> Forgot your password?</a>
                                </div>
                                {{ csrf_field() }}
                            </div>
                        </form>
