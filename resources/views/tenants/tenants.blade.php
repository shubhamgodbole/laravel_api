                     ...
                     <div class="col-sm-12">
                        <div class="page-title-box">
                           <div class="row align-items-center">
                              <div class="col-md-8">
                                 <h4 class="page-title mb-0">Tenants</h4>
                              </div>
    	                        <div class="col-md-4">
									<div class="float-right ">
										<div class="">
											<a class="btn btn-primary btn-rounded " href="{{ url('/tenants/add_tenant') }}" > Add New</a>
										</div>
									</div>
								</div>
                           </div>
									...
									<tr>
										...
										<td>
													...
													<div class="dropdown-menu dropdown-menu-right dropdown-menu-animated">
														<a class="dropdown-item" href="users/edit_user/{{$u->id}}">Edit</a> 
						...
						$.ajax({
							...
							success: function (data) {
								if(data) {
									...
									toastr.success('Amenities status is updated successfully')
									window.location.reload();
								}
							}         
						});
