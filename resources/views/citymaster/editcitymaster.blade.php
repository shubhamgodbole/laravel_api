                     ...
                     <div class="col-sm-12">
                        <div class="page-title-box">
                           <div class="row align-items-center">
                              <div class="col-md-8">
                                 <h4 class="page-title mb-0">Update City</h4>
							...
							<div class="col-12">
								<div class="card">
									<div class="card-body">
										<h4 class="mt-0 header-title">Update City</h4>
										<div class="form-body">
                            <form method="post" action="{{ url('/citymaster/updateCity') }}" enctype="multipart/form-data" autocomplete="off"> 
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="name">City Name</label>
                                            <input type="hidden"  value="{{ $edit_data->id }}" name="id"> 
                                            <input type="text" class="form-control" value="{{ $edit_data->service_city_name }}" required name="city_name" id="city_name" placeholder="Enter city name"> 
                                            @error('city_name')
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"  value="{{ $edit_data->service_city_code }}" required name="city_code" id="city_code" placeholder="Enter city code"> 
                                            @error('city_code')
                                                <span class="error_msg">{{$message}}</span>
                                            @enderror
                                        </div>    
