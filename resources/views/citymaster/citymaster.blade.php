               ...
               <div class="container-fluid">
                     ...
                     <div class="col-sm-12">
                        <div class="page-title-box">
                           <div class="row align-items-center">
                              <div class="col-md-8">
                                 <h4 class="page-title mb-0">City Master</h4>
                              </div>
	                            <div class="col-md-4">
                  ...
                  <!-- end row -->
							...
							<div class="col-12">
								<div class="card">
									<div class="card-body">
										<h4 class="mt-0 header-title">City Master</h4>
										<div class="">
								  ...
								  <th>Actions</th>
											...
											<tbody>
								@foreach($citymaster as  $index => $u)
									<tr>
										<th scope="row">{{  $index + 1  }}</th>
										<td>{{ $u->service_city_name }}</td>
										<td> {{ $u->service_city_code }}</td>
										...
										<td>
													...
													<div class="dropdown-menu dropdown-menu-right dropdown-menu-animated">
														<a class="dropdown-item" href="citymaster/edit_city/{{$u->id}}">Edit</a> 
