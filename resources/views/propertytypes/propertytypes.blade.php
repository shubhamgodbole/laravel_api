                     ...
                     <div class="col-sm-12">
                        <div class="page-title-box">
                           <div class="row align-items-center">
                              <div class="col-md-8">
                                 <h4 class="page-title mb-0">Property Type</h4>
							...
							<div class="col-12">
								<div class="card">
								  ...
								  <th>Actions</th>
											...
											<tbody>
								@foreach($propertytype as  $index => $u)
									<tr>
										...
										<td>
													...
													<div class="dropdown-menu dropdown-menu-right dropdown-menu-animated">
														<a class="dropdown-item" href="property_types/edit_property_type/{{$u->id}}">Edit</a> 
            ...
            swal({
                ...
                .then((willDelete) => {
					if (willDelete) {
						$.ajax({
							type: "GET",
							url : "{{url('property_types/changeActivationStatus/')}}" + "/" + id,
							success: function (data) {
								if(data) {
									//swal("Deleted Successfully");
									toastr.options = {
									...
									toastr.success('Property type status is updated successfully')
									window.location.reload();
								}
							}         
						});
