                     ...
                     <div class="col-sm-12">
                        <div class="page-title-box">
                           <div class="row align-items-center">
                              <div class="col-md-8">
                                 <h4 class="page-title mb-0">Add Property Type</h4>
                                 <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="{{ url('/property_types') }}">Property Types</a></li>
                  ...
                  <!-- end row -->
						<div class="row">
							<div class="col-12">
								<div class="card">
									<div class="card-body">
										<h4 class="mt-0 header-title">Property Type</h4>
										<div class="form-body">
                                            <form method="post" action="addPropertyType" enctype="multipart/form-data" autocomplete="off"> 
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="name">Property Type</label> 
                                                            <input type="text" class="form-control" required name="name" id="name" placeholder="Enter first name"> 
                                                            @error('name')
